...
export const ProfileView = ({
	...
	const favoriteMovies = movies.filter((m) =>
		user.FavoriteMovie.includes(m._id)
	);
	...
	const handleSubmit = (event) => {
		...
		fetch(
			'https://mi-movie-app-6566ce5d2cb3.herokuapp.com/users/' + user.Username,
			{
				method: 'PUT',
		...
		<>
			...
			<Container>
				<Row>
					...
					<p></p>
					<Row>
						<Col className='mx-5 d-flex g-8' xs={12} sm={6} md={4} lg={3} fluid>
							{' '}
